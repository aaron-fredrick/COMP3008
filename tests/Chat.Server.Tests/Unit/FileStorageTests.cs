    ...
    internal static class FileStorageTests
    {
        public static void Run()
        {
            ...
            try
            {
                ...
                ValidationRejectsEmptyAndOversizedFiles(root);
                ValidationRejectsUnsafeAndUnsupportedNames(root);
                ExactlyTwoMegabytesIsAccepted(root);
                FailedContentWriteDoesNotLeaveMetadata(root);
                FileIoDoesNotHoldMetadataLock(root);
                ClearChannelRemovesMetadataAndContent(root);
            }
            finally
            {
        ...
        private static void ValidationRejectsEmptyAndOversizedFiles(string root)
        {
        ...
        private static void ValidationRejectsUnsafeAndUnsupportedNames(string root)
        {
        ...
        private static void ExactlyTwoMegabytesIsAccepted(string root)
        {
        ...
        private static void FailedContentWriteDoesNotLeaveMetadata(string root)
        {
        ...
        private static void FileIoDoesNotHoldMetadataLock(string root)
        {
        ...
        private static void ClearChannelRemovesMetadataAndContent(string root)
        {
